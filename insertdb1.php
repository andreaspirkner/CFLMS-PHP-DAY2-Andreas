...
$sql = "INSERT INTO Cars (make, model, location, price, availability) VALUES ('$make', '$model', '$location', '$price', '$availability')";
...
?>
 ...
 </div><!--END CREATING HTML INPUT FORM CARS-->
