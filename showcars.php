...
*/ 
$sql = "SELECT car_id, make, model, location, price, availability FROM Cars";
$result = mysqli_query($conn, $sql);
// fetch the next row (as long as there are any) into $row 
while($row = mysqli_fetch_assoc($result)) {
       printf("ID=%s, %s (%s), %s, € %s, %s available<br>",
                     $row[ "car_id"], $row["make"],$row["model"], $row["location"],$row["price"], $row["availability"]);
}
...
?> 
 ...
 </div><!--END GET DATA SHOW  CAR RECORDS-->
